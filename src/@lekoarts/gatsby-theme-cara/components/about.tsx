...
const About = ({offset, factor = 1}: { offset: number; factor?: number }) => (
    <div>
        ...
        <Divider speed={0} offset={offset - 0.5} factor={factor}>
            <UpDown>
                ...
                <SVG icon="bitbaloon" width={8} hiddenMobile stroke color="icon_darkest" left="25%" top="5%"/>
                <SVG icon="balloonSmall" width={24} color="icon_orange" left="80%" top="120%"/>
            </UpDown>
            <UpDownWide>
                <SVG icon="bitbaloon" width={16} hiddenMobile color="icon_purple" left="5%" top="80%"/>
                <SVG icon="cake" width={12} stroke color="icon_brightest" left="95%" top="50%"/>
                <SVG icon="bitbaloon" width={6} hiddenMobile color="icon_brightest" left="85%" top="15%"/>
                <SVG icon="party" width={8} color="icon_darkest" left="45%" top="10%"/>
            </UpDownWide>
            <SVG icon="circus" width={6} hiddenMobile  color="icon_brightest" left="4%" top="20%"/>
            ...
            <SVG icon="circus" width={40} hiddenMobile  color="icon_bordo" left="80%" top="85%"/>
            ...
            <UpDownWide>
                <SVG icon="balloonSmall"  hiddenMobile width={16} color="icon_pink" left="80%" top="10%"/>
                <SVG icon="cake" width={12} color="icon_bordo" left="90%" top="130%"/>
                <SVG icon="bitbaloon" width={16} color="icon_darker" left="70%" top="110%"/>
                <SVG icon="balloon" width={16} stroke color="icon_bordo" left="30%" top="65%"/>
            ...
            <SVG icon="circus" hiddenMobile width={24} stroke color="icon_bordo" left="5%" top="120%"/>
            ...
            <SVG icon="balloonSmall" width={8} color="icon_darkest" left="85%" top="115%"/>
            <SVG icon="balloonSmall" hiddenMobile width={24} color="icon_darker" left="40%" top="130%"/>
            <SVG icon="circus" width={24} stroke color="icon_darker" left="85%" top="0%"/>
